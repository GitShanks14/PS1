...
% set EnableFSPL to be true if you want to observe the effects of FSPL as
% well. The simulation without the FSPL is more illustrative of what
% channel estimation does. 
EnableFSPL = false;
...
CD1 = comm.ConstellationDiagram('Name',"Raw Data");
CD2 = comm.ConstellationDiagram('Name',"After correction");
